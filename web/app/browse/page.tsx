...
/**
 * Real folder browser, starting from $HOME's own top-level entries
 * (root.path = "__root__"). Moved here from app/page.tsx on 2026-09-01
 * — the landing page is the category summary (spec.md FR-002); this is
 * where actual folder-by-folder browsing lives, a head start on the
 * drill-down work planned for T013/T014.
 */
    ...
    <div className="flex h-screen flex-col overflow-hidden">
      <header className="flex items-center justify-between border-b border-[var(--border)] px-6 py-5">
        <div className="flex items-baseline gap-3">
          <Link
            href="/"
            className="mr-2 text-sm text-[var(--text-secondary)] transition-colors hover:text-[var(--accent)]"
          >
            ← Categories
          </Link>
